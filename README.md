...
[![Release](https://img.shields.io/badge/Release-v0.8.9-blue.svg?style=flat-square)](https://github.com/lianchengwu/lmplayer/releases)
...
### 自动化发布流程
只需向仓库推送以 `v` 开头的版本标签（例如 `v0.8.9`），CI 将自动完成编译、打包并创建 GitHub Release 发布：
